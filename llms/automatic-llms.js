...
const PAGE_ENTRIES = [
  {
    ...
    facts: [
      ...
      'Routes primary ordering CTAs to the product-selection flow.',
    ],
  },
  {
    type: 'collection',
    ...
    summary: 'Primary product-selection route for choosing the Classic Phone or Rugged Phone.',
    facts: [
      'Shows the two-phone catalog instead of a broad product grid.',
      'Keeps the purchase path focused on the family phone decision.',
    ],
  },
  {
    type: 'page',
    title: 'Guided Order Builder',
    path: '/pages/order-now',
    summary: 'Guided purchase flow for Patriot Package, phone choice, service plan, and add-ons.',
    facts: [
...
function renderEntryLlmsTxt(manifest, entry) {
  ...
  lines.push(
    ...
    `- [Order Now](${absoluteUrl(manifest.website, '/collections/all')})`,
